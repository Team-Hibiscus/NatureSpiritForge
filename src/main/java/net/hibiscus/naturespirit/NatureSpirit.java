...
public class NatureSpirit {
    ...
    private void commonSetup(final FMLCommonSetupEvent event) {
        ...
        event.enqueueWork(() -> {
            ...
            ComposterBlock.COMPOSTABLES.put(NSBlocks.RED_MOSS_BLOCK.get().asItem(), 0.65F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.RED_MOSS_CARPET.get().asItem(), 0.3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.LOTUS_FLOWER_ITEM.get(), 0.65F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.LOTUS_STEM.get().asItem(), 0.2F);
            ...
            ComposterBlock.COMPOSTABLES.put(NSBlocks.DESERT_TURNIP.get().asItem(), 0.3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.DESERT_TURNIP_BLOCK.get().asItem(), 0.65F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.DESERT_TURNIP_ROOT_BLOCK.get().asItem(), 0.5F);
            ...
            ComposterBlock.COMPOSTABLES.put(NSBlocks.COCONUT_THATCH.get().asItem(), 0.65F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.COCONUT_THATCH_CARPET.get().asItem(), 0.1F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.COCONUT_THATCH_STAIRS.get().asItem(), 0.5F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.COCONUT_THATCH_SLAB.get().asItem(), 0.3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.XERIC_THATCH.get().asItem(), 0.65F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.XERIC_THATCH_CARPET.get().asItem(), 0.1F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.XERIC_THATCH_STAIRS.get().asItem(), 0.5F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.XERIC_THATCH_SLAB.get().asItem(), 0.3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.EVERGREEN_THATCH.get().asItem(), 0.65F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.EVERGREEN_THATCH_CARPET.get().asItem(), 0.1F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.EVERGREEN_THATCH_STAIRS.get().asItem(), 0.5F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.EVERGREEN_THATCH_SLAB.get().asItem(), 0.3F);

            ComposterBlock.COMPOSTABLES.put(NSBlocks.REDWOOD.getSapling().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.SUGI.getSapling().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.WISTERIA.getPurpleSapling().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.WISTERIA.getWhiteSapling().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.WISTERIA.getBlueSapling().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.WISTERIA.getPinkSapling().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.FIR.getSapling().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.WILLOW.getSapling().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.ASPEN.getSapling().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.MAPLE.getRedSapling().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.MAPLE.getOrangeSapling().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.MAPLE.getYellowSapling().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.CYPRESS.getSapling().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.OLIVE.getSapling().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.JOSHUA.getSapling().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.GHAF.getSapling().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.PALO_VERDE.getSapling().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.CEDAR.getSapling().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.LARCH.getSapling().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.MAHOGANY.getSapling().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.SAXAUL.getSapling().get().asItem(), .3F);

            ComposterBlock.COMPOSTABLES.put(NSBlocks.REDWOOD.getLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.REDWOOD.getFrostyLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.SUGI.getLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.WISTERIA.getPurpleLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.WISTERIA.getWhiteLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.WISTERIA.getBlueLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.WISTERIA.getPinkLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.WISTERIA.getPartPurpleLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.WISTERIA.getPartWhiteLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.WISTERIA.getPartBlueLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.WISTERIA.getPartPinkLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.FIR.getLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.FIR.getFrostyLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.WILLOW.getLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.ASPEN.getLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.ASPEN.getYellowLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.MAPLE.getRedLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.MAPLE.getOrangeLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.MAPLE.getYellowLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.CYPRESS.getLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.OLIVE.getLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.JOSHUA.getLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.GHAF.getLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.PALO_VERDE.getLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.CEDAR.getLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.COCONUT.getLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.LARCH.getLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.MAHOGANY.getLeaves().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.SAXAUL.getLeaves().get().asItem(), .3F);

            ComposterBlock.COMPOSTABLES.put(NSBlocks.WISTERIA.getPurpleVines().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.WISTERIA.getWhiteVines().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.WISTERIA.getBlueVines().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.WISTERIA.getPinkVines().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.WILLOW.getVines().get().asItem(), .3F);

            ComposterBlock.COMPOSTABLES.put(NSBlocks.LAVENDER.getFlowerBlock().get().asItem(), .4F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.BLEEDING_HEART.getFlowerBlock().get().asItem(), .4F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.BLUE_BULBS.getFlowerBlock().get().asItem(), .4F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.CARNATION.getFlowerBlock().get().asItem(), .4F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.GARDENIA.getFlowerBlock().get().asItem(), .4F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.SNAPDRAGON.getFlowerBlock().get().asItem(), .4F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.FOXGLOVE.getFlowerBlock().get().asItem(), .4F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.BEGONIA.getFlowerBlock().get().asItem(), .4F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.MARIGOLD.getFlowerBlock().get().asItem(), .4F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.BLUEBELL.getFlowerBlock().get().asItem(), .4F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.TIGER_LILY.getFlowerBlock().get().asItem(), .4F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.PURPLE_WILDFLOWER.getFlowerBlock().get().asItem(), .4F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.YELLOW_WILDFLOWER.getFlowerBlock().get().asItem(), .4F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.RED_HEATHER.getFlowerBlock().get().asItem(), .4F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.WHITE_HEATHER.getFlowerBlock().get().asItem(), .4F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.PURPLE_HEATHER.getFlowerBlock().get().asItem(), .4F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.ANEMONE.getFlowerBlock().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.DWARF_BLOSSOMS.getFlowerBlock().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.PROTEA.getFlowerBlock().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.HIBISCUS.getFlowerBlock().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.BLUE_IRIS.getFlowerBlock().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.BLACK_IRIS.getFlowerBlock().get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.RUBY_BLOSSOMS.getFlowerBlock().get().asItem(), .4F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.SILVERBUSH.getFlowerBlock().get().asItem(), .4F);

            ComposterBlock.COMPOSTABLES.put(NSBlocks.CATTAIL.get().asItem(), .4F);

            ComposterBlock.COMPOSTABLES.put(NSBlocks.TALL_FRIGID_GRASS.get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.FRIGID_GRASS.get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.TALL_SCORCHED_GRASS.get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.SCORCHED_GRASS.get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.TALL_BEACH_GRASS.get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.BEACH_GRASS.get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.TALL_SEDGE_GRASS.get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.SEDGE_GRASS.get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.LARGE_FLAXEN_FERN.get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.FLAXEN_FERN.get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.TALL_OAT_GRASS.get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.OAT_GRASS.get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.LARGE_LUSH_FERN.get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.LUSH_FERN.get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.TALL_MELIC_GRASS.get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.MELIC_GRASS.get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.GREEN_BEARBERRIES.get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.RED_BEARBERRIES.get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.PURPLE_BEARBERRIES.get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.GREEN_BITTER_SPROUTS.get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.RED_BITTER_SPROUTS.get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.PURPLE_BITTER_SPROUTS.get().asItem(), .3F);

            ComposterBlock.COMPOSTABLES.put(NSBlocks.OLIVES.get().asItem(), .3F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.OLIVE_BRANCH.get().asItem(), .5F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.COCONUT_BLOCK.get().asItem(), .2F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.COCONUT_SPROUT.get().asItem(), .2F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.COCONUT_SHELL.get().asItem(), .1F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.COCONUT_HALF.get().asItem(), .1F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.SHIITAKE_MUSHROOM.get().asItem(), .1F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.GRAY_POLYPORE.get().asItem(), .1F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.ALLUAUDIA.get().asItem(), .2F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.ALLUAUDIA_BUNDLE.get().asItem(), .2F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.STRIPPED_ALLUAUDIA.get().asItem(), .2F);
            ComposterBlock.COMPOSTABLES.put(NSBlocks.STRIPPED_ALLUAUDIA_BUNDLE.get().asItem(), .2F);
